...
class Routine:
    def __init__(self, name, days_of_week, start_time=None, end_time=None, total_hours=0):
        ...
        self.start_time = start_time
        self.end_time = end_time
        self.total_hours = total_hours  # This was the missing attribute
        self.is_flexible = (start_time is None)

# --- 2. The "Brain" - Scheduler Class v6.1 ---
...
if __name__ == "__main__":
    ...
    # Using a simplified list for clarity, as many tasks were completed
    all_user_tasks = [
    ...
    print("\n--- Your AI-Generated Daily Schedule (v6.1 Corrected) ---")
